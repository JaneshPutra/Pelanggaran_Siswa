...
router.get("/pelanggaran_siswa", (req,res) => {
    // create sql query
    let sql = "select pelanggaran.id_pelanggaran_siswa, pelanggaran.id_siswa,pelanggaran.waktu, siswa.nis, siswa.nama_siswa, pelanggaran.id_user, user.nama_user " +
     "from pelanggaran_siswa pelanggaran join siswa siswa on pelanggaran.id_siswa = siswa.id_siswa " +
     "join user user on pelanggaran.id_user = user.id_user"
